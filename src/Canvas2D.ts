...
class Canvas2D {
    ...
    renderObject(object: GameObject, position: Point = new Point(0, 0)) {
        this.context.strokeStyle = object.figure.style.color;
        ...
        const activeSprite = object.sprites.active.list[object.active].image;
        this.context.drawImage(activeSprite, position.x, position.y, object.figure.size.x, object.figure.size.y);
